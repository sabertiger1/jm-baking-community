...
from . import api_tokens, crud, forgot_password, images, ratings, registration, user_details
...
router.include_router(user_details.router, prefix=user_prefix, tags=["Users: Details"])
